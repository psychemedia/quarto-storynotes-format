...
% Add font support for Middle English alphabet / Middle English characters
...
\AtBeginDocument{
  ...
  \tcbset{top=4mm, bottom=2mm, before upper={\setlength{\parskip}{1em}\setlength{\parindent}{0pt}}, fonttitle=\bfseries}
